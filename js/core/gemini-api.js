...
async function auditarComGemini(assuntoTicket, textoCorpo, numeroTicket, resultadosRegexAnteriores) {
    ...
    try {
        ...
        // NOVO PROMPT: FORMATADO PARA A AUTOMAÇÃO DE ABERTURA (FASE 3)
        const promptText = `
        ...
        1. Carga horária: Máximo de 6h diárias de estágio (desconte o intervalo se houver).
        ...
        5. Atividades: Extraia as 3 principais funções solicitadas no texto, reescrevendo-as de forma curta e genérica (ex: "Auxiliar nas rotinas administrativas", "Atendimento ao cliente").
